...
public class KthLargestNumber {
    public static void main(String[] args) {
        ...
        System.out.println(findKthRankedElement(nums,10));
    }
    /**
     * Find the kTh ranked element in the list.
     * It is expected that nums list won't be modified in process.
     *
     * @param nums List.
     * @param k k.
     * @throws IllegalArgumentException If size of list lesser than k
     * @return KTh ranked element in the list.
     */
    public static double findKthRankedElement(List<Double> nums, int k) {
        if(nums.size() < k) {
